...
public class Main {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        System.out.println(cyan+j1.getNombre()+" ha terminado con "+j1.getPuntuacion()+" puntos"+reset);
        System.out.println(blue+j2.getNombre()+" ha terminado con "+j2.getPuntuacion()+" puntos"+reset);
